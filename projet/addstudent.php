...
<body class="page vh-100">
    <form action="crudstudent.php" method="POST" class="bg-white d-flex justify-content-center container-fluid bg-white sign_in p-3 w-md-75">
        <fieldset>
            ...
            <input type="tel" max="10" class="form-control" placeholder="your Phone" value="<?php echo $phone; ?>" name="phone">
            </div>
            <div class="mb-2">
            <label class="form-label ms-lg-3"> Enroll Number </label>
            <input type="text" max="16" class="form-control" placeholder="your Enroll Number" value="<?php echo $enroll_number; ?>" name="enrollnu">
            </div>
            <?php
            if($update== true):
             ?>
